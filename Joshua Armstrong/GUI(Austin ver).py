...
csv_header = ["Date/Time", "Rshunt", "V1", "V2", "V3", "V4", "Current", "Flags"]
with open(job_number, 'a', newline='') as csvfile:
...
def update_levels():
         ...
         for i in range(len(slist)):
            ...
            if (slist_pointer + 1) > (len(slist)):
                ...
                if dec_count == 1:
                    ...
                    csv_list = [dt_string, shunt_resistor, all_volts[0], all_volts[1], all_volts[2], all_volts[3], amps, flag_output_str]
    ...
    job_window.after(500, update_levels)
...
def get_settings():
    ...
    def close_okay():
        ...
        settings_details = f"Save file: \t\t{job_number}\n" + \
            f"COM Port: \t\t{com_port}\n" + \
